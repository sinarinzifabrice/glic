...
class BienTest extends TestCase
{
    ...
    public function test_Modifier_le_crayon_de_la_base_de_donnees(){
        ...
        // Vérifie si la réponse redirige vers la route de détails du bien mis à jour
        ...
        $this->assertEquals($nouvellesDonnees['type'], $bienMisAJour->type);
        $this->assertEquals($nouvellesDonnees['marque'], $bienMisAJour->marque);
        $this->assertEquals($nouvellesDonnees['couleur'], $bienMisAJour->couleur);
        $this->assertEquals($nouvellesDonnees['quantite'], $bienMisAJour->quantite);
