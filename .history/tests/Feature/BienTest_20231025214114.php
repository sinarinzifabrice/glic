...
class BienTest extends TestCase
{
    ...
    public function test_Supprimer_le_crayon_de_la_base_de_donnees(){
        // Crée un crayon que vous souhaitez supprimer
        ...
        // Effectue une requête HTTP DELETE pour supprimer le crayon
        ...
        // Vérifie si le crayon a été supprimé de la base de données
        $this->assertDatabaseMissing('crayons', $crayon->toArray());

        // Vérifie si le nombre total de crayons dans la base de données est égal à 0

        $this->assertDatabaseCount('crayons',0);
    }
