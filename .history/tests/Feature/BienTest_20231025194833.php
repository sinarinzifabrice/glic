...
class BienTest extends TestCase
{
    ...
    public function test_Creer_un_bien_avec_toutes_les_valeur_fournies(){
        ...
        $response = $this->post('crayons',$bien);
        ...
        $this->assertDatabaseHas('crayons', $bien);
        ...
        $this->assertEquals($bien['type'], $derniercrayon->type);
        $this->assertEquals($bien['prix'], $derniercrayon->prix);
