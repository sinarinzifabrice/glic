...
class BienTest extends TestCase
{
    ...
    public function test_Affiche_un_formulaire_preremplie_pour_modifier_un_crayon(){
        ...
        // le type, le prix, la marque, la quantité et la couleur du crayon
        $response->assertSee('value="' . $crayon->type . '"', false);
        $response->assertSee('value="' . $crayon->prix . '"', false);
        $response->assertSee('value="' . $crayon->marque . '"', false);
        $response->assertSee('value="' . $crayon->quantite . '"', false);
        $response->assertSee('value="' . $crayon->couleur . '"', false);


        // Vérifie si la vue a reçu la variable "crayon"
        // qui contient les détails de l'objet du crayon
        $response->assertViewHas('crayon', $crayon);
