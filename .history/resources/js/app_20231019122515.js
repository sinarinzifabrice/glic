// import './bootstrap'; import moment from 'moment';
...
function validerDates() {
    ...
    const dateDebut = moment('2023-10-19', 'YYYY-MM-DD');
    const dateFin = moment('2023-10-19', 'YYYY-MM-DD');
