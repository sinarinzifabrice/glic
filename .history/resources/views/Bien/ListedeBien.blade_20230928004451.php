            ...
            <div class="bien card mb-3 rounded-4" style="max-width: 540px;">
                <div class="image">
                    @if ($bien->photo != null || $bien->photo != "pas-de-photo.jpg")
                        <img src={{ Storage::url("/public/storage/images/".$bien->photo) }} class="card-img-top" alt="">
                    @else
                        <img src={{ Storage::url("/public/storage/images/unnamed.jpg") }} class="card-img-top" alt="...">
                    @endif
                </div>
                <div class="row g-0">
