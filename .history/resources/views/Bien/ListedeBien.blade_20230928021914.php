            ...
            <div class="bien card mb-3 rounded-4" style="max-width: 60%;">
                <div class="image">
                    @if ($bien->photo === null || $bien->photo === "pas-de-photo.jpg")
                        ...
                        <img src={{ asset('storage/images/unnamed.jpg') }} class="img rounded-start" style="aspect-ratio: auto" alt="...">
                    @else
                    <img src={{ asset('storage/images/'.$bien->photo) }} class="img" alt="" style="aspect-ratio: auto">
                    @endif
                </div>
                <div class="row g-0">
