            ...
            <div class="bien card mb-3 rounded-4" style="max-width: 60%;">
                <div class="image">
                    @if ($bien->photo === null || $bien->photo === "pas-de-photo.jpg")
                        ...
                        <img src={{ asset('storage/images/unnamed.jpg') }} class="img rounded-start" style="width: 400px;
                        aspect-ratio: auto 1 / 1" alt="...">
                    @else
                    <img src={{ asset('storage/images/'.$bien->photo) }} class="img" alt="" style="width: 300px;
