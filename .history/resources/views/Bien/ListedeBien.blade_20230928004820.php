...
@section('contenu')
    <div class="mt-4 d-flex justify-content-between align-items-center px-4">
        ...
        <img src={{ asset('storage/images/'.'unnamed.jpg') }} alt="" srcset="">
    </div>


    <div class="container">
        @foreach ($biens as $bien)
            <div class="bien card mb-3 rounded-4" style="max-width: 540px;">
                <div class="image">
                    @if ($bien->photo != null || $bien->photo != "pas-de-photo.jpg")
                        <img src={{ asset('/public/storage/images/''.$bien->photo) }} class="card-img-top" alt="">
                    @else
                        <img src={{ asset("/public/storage/images/unnamed.jpg") }} class="card-img-top" alt="...">
                    @endif
                </div>
                <div class="row g-0">
