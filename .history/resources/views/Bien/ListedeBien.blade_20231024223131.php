            ...
            @foreach ($biens as $bien)
                <div class="card mb-3 rounded-4">
                    ...
                    <div class="card-body">
                        ...
                        @if ($bien->statut == '0')
                            <p class="card-text mb-2"><span class="badge rounded-pill text-bg-danger">vide</span></p>
                        @endif
                        @if ($bien->statut == '1')
                            <p class="card-text mb-2"><span class="badge rounded-pill text-bg-success">occupe</span></p>
                        @endif
                        <h2 class="card-title">{{ $bien->typede_Bien->type }} </h2>
                        <p class="card-text mb-2"><small class="text-muted">{{ $bien->numrue }} {{ $bien->nomrue }}</small>
                        </p>
