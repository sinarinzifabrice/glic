    ...
    <div class="container">
        ...
        <div class="mt-4">
            @foreach ($biens as $bien)
                <div class="bien card mb-3 rounded-4">

                    @if ($bien->photo === null || $bien->photo === "pas-de-photo.jpg")

                        <img src={{ asset('storage/images/unnamed.jpg') }} class="card-img-top img-fluid" style="width: 300px;
                        aspect-ratio: auto 1 / 1" alt="">
                    @else
                    <img src={{ asset('storage/images/'.$bien->photo) }} class="card-img-top img-fluid" alt="">
                    @endif
