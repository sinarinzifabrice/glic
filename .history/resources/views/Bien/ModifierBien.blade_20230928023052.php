    ...
    <div class="container">
        ...
        <form id="bien" name="bien" class="needs-validation row g-3" method="POST" action="{{ route('bien.update', $bien->id) }}" novalidate enctype="multipart/form-data">
            ...
            <div class="col-8">
                ...
                <input type="hidden" id="ancienphoto" name="ancienphoto" value="{{ "storage/images/".$bien->photo }}">
                ...
                @if ($bien->photo === null || $bien->photo === "pas-de-photo.jpg")
                    ...
                    @endif
                <input class="form-control" type="file" value ="{{ "storage/images/".$bien->photo }}" name="photo" id="photo" accept="image/jpg, image/jpeg, image/png">
              </div>
