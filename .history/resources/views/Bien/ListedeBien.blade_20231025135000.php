            ...
            @foreach ($biens as $bien)
                <div class="card mb-3 rounded-4">
                    ...
                    @if ($bien->photo === null || $bien->photo === "pas-de-photo.jpg")
                        ...
                        <img src={{ asset('storage/images/unnamed.jpg') }} class="card-img-top rounded-top-4" alt="">
                    @else
                    <img src={{ asset('storage/images/'.$bien->photo) }} class="card-img-top rounded-top-4" alt="">
                    @endif

                    <div class="card-body">

                        @if ($bien->statut == '0')
                            <p class="card-text mb-4"><span class="badge rounded-pill text-bg-danger">vide</span></p>
                        @endif
                        @if ($bien->statut == '1')
                            <p class="card-text mb-4"><span class="badge rounded-pill text-bg-success">occupe</span></p>
                        @endif
                        ...
                        <p class="card-text mb-4">le loyer est de {{ $bien->loyer }}$</p>

                        <div class="d-flex flex-row justify-content-between">
                            <a href="{{ route('bien.edit', $bien->id) }}" class="btn btn-outline-info btn-sm"><i
                                    class="fa-regular fa-pen-to-square"></i>modifier</a>
                            <a href="{{ route('bien.show', $bien->id) }}" class="btn btn-outline-info btn-sm">
