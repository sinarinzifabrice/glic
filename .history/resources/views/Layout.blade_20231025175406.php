            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/locataires">Locataires</a>
                        </li>
                        ...
                        <li>
                            @auth
                                ...
                                @else
                                <li>
                                    <a href="{{ route('login') }}" class="nav-link btn btn-outline-secondary">Se connecter</a>
                                </li>

                                 <li>
                                    <a href="{{ route('register') }}" class="nav-link btn-danger">S'inscrire</a>
                                </li>
