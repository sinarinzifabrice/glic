                ...
                <div class="card mb-4" style="max-width: 540px;">
                    <div class="card-body">
                        @if ($contrat->approuve == '0')
                            <p class="card-text mb-2"><span class="badge rounded-pill text-bg-warning">en attante</span></p>
                        @endif
                        @if ($contrat->approuve == '1')
                            <p class="card-text mb-2"><span class="badge rounded-pill text-bg-success">approuvé</span></p>
                        @endif
                        <h2 class="card-title"><span class="fw-bold">{{ $contrat->Locataire->nom }} {{ $contrat->Locataire->prenom }} </span></h2>

                        <h2 class="fw-bold">Contrat Du {{ $contrat->datedebut }} Au {{ $contrat->datefin }}</h2>
