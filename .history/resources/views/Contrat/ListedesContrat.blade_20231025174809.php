            ...
            @foreach ($contrats as $contrat)
                <div class="card mb-4" style="max-width: 540px;">
                    <div class="card-body">
                        ...
                        <h2 class="card-text">{{ $contrat->Bien->numrue }} {{ $contrat->Bien->nomrue }}</h2>
                        <h2 class="card-text">{{ $contrat->Bien->quartier }} {{ $contrat->Bien->ville }}</h2>
                        <div class="card-body d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ route('contrats.show', $contrat->id) }}" class="btn btn-outline-info btn-sm">
