                            ...
                            @if (Route::has('login'))
                                <div class="tw-fixed tw-top-0 tw-right-0 p-6 tw-text-right tw-z-10">
                                    @auth
                                        ...
                                        class="tw-font-semibold tw-text-gray-600 tw-hover:text-gray-900 tw-dark:text-gray-400 tw-dark:hover:text-white tw-focus:tw-outline tw-focus:tw-outline-2 tw-focus:tw-rounded-sm tw-focus:tw-outline-red-500">
                                            Dashboard
                                        </a>
                                        @else
                                            <a href="{{ route('login') }}"
                                        ...
                                        @if (Route::has('register'))
                                            ...
                                            class="tw-ml-4 tw-font-semibold tw-text-gray-600 tw-hover:text-gray-900 tw-dark:text-gray-400 tw-dark:hover:text-white tw-focus:tw-outline tw-focus:tw-outline-2 tw-focus:tw-rounded-sm tw-focus:tw-outline-red-500">Register</a>
                                        @endif
                                    @endauth
                                </div>
                            @endif
