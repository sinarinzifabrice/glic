                ...
                <tbody>
                    @foreach ($types as $type)
                        <tr>
                            <td>{{ $type->id }}</td>
                            <td>{{ $type->type }}</td>
                            <td><a href="{{ route('typedebiens.edit', $type->id) }}" class="btn btn-outline-primary">
                                <i
                            ...
                            <td>
                                <form action="/typedebiens/{{ $type->id }}" method="POST">
                                    ...
                                    <button class="btn btn-outline-danger btn-sm"
                                        onclick="return confirm('Souhaitez-vous procéder à la suppression du type {{ $type->type }} ?');">
                                        <i class="fa-regular
                                        fa-trash-can"></i>
                                        supprimer
                                    </button>
