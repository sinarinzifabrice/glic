    ...
    <div class="container">
        ...
        <form id="locataire" name="locataire" class="needs-validation row g-3" method="POST"
            ...
            <div class="formgroup col-6">
                ...
                @enderror
                <div class="invalid-feedback">
                    <p>Le champ courriel est obligatoire</p>
                </div>
            </div>
            <div class="formgroup col-md-6">
                ...
                @enderror
                <div class="invalid-feedback">
                    <p>Le champ courriel de contact est obligatoire</p>
                </div>
            </div>
            <div class="formgroup col-6">
                ...
                @enderror
                <div class="invalid-feedback">
                    <p>Le champ telephone est obligatoire</p>
                </div>
            </div>
            <div class="formgroup col-md-6">
                ...
                <input type="text" class="form-control" id="nomentreprise" name="nomentreprise"
                    value="{{ $locataire->nomentreprise }}">
                @error('nomentreprise')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
                    <p>Le champ nom entreprise est obligatoire</p>
                </div>
            </div>
