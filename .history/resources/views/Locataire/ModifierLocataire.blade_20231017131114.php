...
@section('contenu')
    ...
    <div class="container">
        ...
        <form id="locataire" name="locataire" class="needs-validation row g-3" method="POST"
            action="{{ route('locataire.update', $locataire->id) }}" novalidate>
            @method('PUT')
            @csrf
            <div class="formgroup col-md-6">
                <label for="nom" class="form-label">Nom<sup>*</sup></label>
                <input type="text" class="form-control" id="nom" name="nom"
                    value="{{ old('nom') ? old('nom') : $locataire->nom }}">
                @error('loyer')
            ...
            <div class="formgroup col-md-6">
                ...
                <input type="text" class="form-control" id="prenom" name="prenom"
                    value="{{ old('prenom') ? old('prenom') : $locataire->prenom }}" title="le champ est obligatoire">
                @error('prenom')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
            ...
            <div class="formgroup col-6">
                ...
                <input type="email" class="form-control" id="email" name="email"
                    value="{{ old('email') ? old('email') : $locataire->email }}" title="le champ est obligatoire">
                @error('email')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
            ...
            <div class="formgroup col-md-6">
                ...
                <input type="email" class="form-control" id="emailcontact" name="emailcontact"
                    value="{{ $locataire->emailcontact }}" title="le champ est obligatoire">
                @error('emailcontact')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
            ...
            <div class="formgroup col-md-6">
                ...
                <input type="text" class="form-control" id="nomentreprise" name="nomentreprise"
                    value="{{ $locataire->nomentreprise }}" title="le champ est obligatoire">
                @error('nomentreprise')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
