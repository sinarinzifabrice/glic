    ...
    <div class="mt-4">
        <div class="card mb-6" style="max-width: 540px;">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card-body">
                        <h2 class="fw-bold"><span></span>Nom complet : {{ $locataire->nom }} {{ $locataire->prenom }}</h2>
                        <h2 class="fw-bold">Courriel : {{ $locataire->email }} </h2>
                        <h2 class="fw-bold">Courriel de contact: {{ $locataire->emailcontact }} </h2>
