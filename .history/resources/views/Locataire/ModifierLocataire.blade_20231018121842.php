        ...
        <form id="locataire" name="locataire" class="needs-validation row g-3" method="POST"
            ...
            <div class="formgroup col-md-6">
                ...
                <input type="text" class="form-control" id="prenom" name="prenom"
                    value="{{ old('prenom') ? old('prenom') : $locataire->prenom }}" title="le champ est obligatoire" required>
                @error('prenom')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
            ...
            <div class="formgroup col-6">
                ...
                <input type="email" class="form-control" id="email" name="email"
                    value="{{ old('email') ? old('email') : $locataire->email }}" title="le champ est obligatoire" required>
                @error('email')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
            ...
            <div class="formgroup col-md-6">
                ...
                <input type="email" class="form-control" id="emailcontact" name="emailcontact"
                    value="{{ $locataire->emailcontact }}" title="le champ est obligatoire" required>
                @error('emailcontact')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
                <div class="invalid-feedback">
