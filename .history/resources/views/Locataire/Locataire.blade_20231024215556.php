            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card-body">
                        ...
                        <h2><span class="fw-blod">Courriel de contact:</span> {{ $locataire->emailcontact }} </h2>
                        <h2><span class="fw-blod">Téléphone : </span>{{ $locataire->telephone }}</h2>

                        @if ($locataire->nomentreprise != null)
                            <h2 class="card-text"><span class="fw-blod">Nom entreprise :</span> {{ $locataire->nomentreprise }} </h2>
                        @endif
