...
class ContratController extends Controller
{
    ...
    {
        return view('Contrat.ListedesContrat', ['contrats' => Contrat::all()->sortByDesc("name")]);
    }
    ...
    public function store(Request $request)
    {
        ...
        // Vérifie si le contrat est approuvé
    ...
    public function destroy(Contrat $contrat): RedirectResponse
    {
        ...
        // Vérifiez si le contrat est approuvé
        if ($contrat->approuve) {
            $bien = Bien::find($contrat->bien);
            if ($bien) {
                // Mettez à jour le statut du bien à false
                $bien->statut = false;
                $bien->save();
            }
        }
