...
class BienController extends Controller
{
    ...
    {
        return view('Biens.ListedeBien', ['biens' => Bien::all()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('biens.index')->with('statut', "Le bien a été créer.");
    }
    ...
    {
        return view('Biens.Bien', ['bien' => $bien]);
    }
