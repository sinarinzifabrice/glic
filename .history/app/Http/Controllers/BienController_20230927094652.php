...
class BienController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('bien.index')->session()->flash('statut', "Le bien a été créer.");
    }
   ...
   /**
    ...
    public function update(Request $request, Bien $bien): RedirectResponse
    {
        ...
        $bien->save();
        return redirect(bien)->route('bien.index')->with('statut', "Le bien dont le muméro est $bien->id  a été modifié.");
    }
    ...
    {
        $bien->delete();
        flash()->addSuccess('Le bien a été bien supprimé.');
