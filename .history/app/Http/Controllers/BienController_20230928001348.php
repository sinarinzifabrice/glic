...
class BienController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            // Une exception s'est produite, vous pouvez gérer l'erreur ici.
            // Par exemple, vous pouvez définir un nom de fichier par défaut ou renvoyer un message d'erreur.
            $filename = 'nom_de_fichier_par_defaut.jpg'; // Remplacez par le nom de fichier par défaut que vous souhaitez utiliser.
        }
