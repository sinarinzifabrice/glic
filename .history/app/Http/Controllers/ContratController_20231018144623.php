...
class ContratController extends Controller
{
    ...
    {
        return view('Contrat.AjouterContrat', ['biens' => Bien::where('statut', '==', false)->get();
    }
    ...
    {
        $contrat->delete();
        return redirect()->route('contrats.index')->with('statut', "la suppression du contrat a été bien effectuée.");
    }
